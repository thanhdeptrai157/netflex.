  ...
  return (
    <div className="w-full rounded-xl overflow-hidden relative text-white transition-all duration-300 h-full aspect-[4/2]">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-10 sm:left-20 z-20 max-w-[90%] sm:max-w-[70%] md:max-w-[50%]">
        <h2 className="text-green-yellow font-black text-sm sm:text-2xl md:text-3xl mb-2 lg:text-4xl">
          {movie?.name}
        </h2>
        ...
        <div className="flex items-center gap-3 flex-wrap text-xs sm:text-sm mb-3">
          <span className="px-2 py-0.5 sm:px-3 sm:py-1 border border-white rounded-full">
            T13
          </span>
        ...
        <div className="flex items-center gap-4 text-xs sm:text-sm mb-4 flex-wrap">
          <span className="flex items-center gap-1">
            <FontAwesomeIcon icon={faLanguage} /> Ngôn ngữ:{" "}
            {movie?.lang || "Cập nhật"}
          </span>
          <span className="flex items-center gap-1">
        ...
        <button
          className="mt-2 px-3 py-2 sm:px-4 sm:py-2 bg-red-500 text-black font-semibold rounded-md flex items-center gap-2 hover:bg-red-600 transition-all text-sm sm:text-base cursor-pointer"
