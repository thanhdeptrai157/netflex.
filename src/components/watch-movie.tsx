...
const LoadMovie = ({ slug }: { slug: string }) => {
  const { episodes, movieDetail, currentEpisode, setCurrentEpisode } =
    useMovieStore();
  ...
  const [pendingResumeEpisode, setPendingResumeEpisode] =
        ...
        try {
          ...
          if (!ignore && progress && progress.episode) {
            ...
            for (const server of episodes) {
              foundEp = server.server_data.find(
                (ep) => ep.name?.trim() === progress.episode?.trim()
              );
              if (foundEp) break;
            }
            if (foundEp) {
          ...
          toast.error(
            "Có lỗi xảy ra khi kiểm tra tiến độ xem." +
    ...
    <div className="w-full flex flex-col gap-3 lg:flex-row">
      ...
      <div className="w-full lg:w-[75%] flex flex-col gap-3">
        ...
        >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 z-10 ">
              <div className="animate-bounce text-center">
                <Image
                  ...
                  height={200}
                />
                <span className="text-white text-center text-[12px] md:text-[16px]">
                  Đang tải phim...
                </span>
              </div>
            </div>
          ...
          <video
            ...
            className={`w-full h-full object-contain ${
              isHideCursor ? "cursor-none" : "cursor-default"
            }`}
            onClick={() => {
          ...
          >
            ...
            <div className="flex justify-between items-center mt-2 gap-2 text-sm text-white">
              ...
              >
                ...
                <span className="hidden md:block ml-1">Bỏ dạo đầu</span>
              </button>
              ...
              >
                ...
                <span className="hidden md:block ml-1">Bỏ quảng cáo</span>
              </button>
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-sm lg:text-xl font-medium text-gray-400 italic">
